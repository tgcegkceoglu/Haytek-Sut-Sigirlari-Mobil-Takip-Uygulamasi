...
import 'package:haytek/ililcesecmesayfasi/veriler.dart';
            ...
            InkWell(
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (_) => SearchSelectPage(
                      ...
                      selectedItem: _secilenIlce,
                      onSelection: (v) {
                        _secilenIlce = v;
                        _bulunduguilcecontroller.text = _secilenIlce;
                        setState(() {});
                      },
                    ),
                  ),
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: TextField(
                    enabled: false,
                    controller: TextEditingController(text: _secilenIlce),
                    decoration: const InputDecoration(
                      labelStyle: TextStyle(
                        fontSize: 14,
                        fontWeight: FontWeight.bold,
...
Future createAnimal({
  ...
  if (secilendosya != null) {
    ...
    final hayvan = HayvanEkleFirebase(
        ...
        dogumtarihi: dogumtarihi,
        dogumturu: dogumturu);
        hayvan.resim="https://firebasestorage.googleapis.com/v0/b/haytekprojesii.appspot.com/o/inek.png?alt=media&token=5d0cfd3e-8c43-410d-a753-d158ecfe1828";
    await dochayvan.set(hayvan.toJson());
  } 
}
